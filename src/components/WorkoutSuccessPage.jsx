...
export function WorkoutSuccessPage({ userName, dayOfWeek, focus, totalSets }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-6 py-8">
      ...
      {/* Success Message */}
      <Card className="w-full border-0 bg-gradient-to-br from-green-50 to-emerald-50 shadow-md dark:from-slate-800 dark:to-slate-900">
        ...
        <CardContent className="space-y-4 text-center">
          ...
          <div className="flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-3 dark:bg-slate-800">
      ...
      {/* User Greeting */}
      {userName && (
        <Card className="w-full border-0 bg-gradient-to-r from-cyan-50 to-blue-50 shadow-sm dark:from-slate-800 dark:to-slate-900">
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-around text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">Rest Day</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="w-full space-y-2">
        <Button
          ...
          className="w-full gap-2 border-amber-200 bg-white text-slate-900 hover:bg-amber-50 dark:border-amber-900 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800"
          variant="outline"
        >
      ...
      {/* Motivational Quote */}
      <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50/50 p-4 text-center dark:border-slate-700 dark:bg-slate-800/50">
        <p className="text-sm italic text-slate-600 dark:text-slate-400">
          "The only way to do great work is to love what you do."
        </p>
        <p className="mt-2 text-xs text-slate-500 dark:text-slate-500">— Steve Jobs</p>
      </div>
    </div>
  );
}
