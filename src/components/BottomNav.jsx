...
export function BottomNav({ activeTab, onTabChange }) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 mx-auto w-full max-w-md border-x border-t border-slate-200/80 bg-white px-2 pt-2 dark:border-slate-800 dark:bg-slate-950">
